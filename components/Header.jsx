...
const Header = () => {
  return (
    <div className=' w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'> 
        ...
        >
            <Image src={assets.profile_img} alt='profile' loading='lazy' className='rounded-full w-32'/>  
        </motion.div>
        <motion.h3
         ...
         className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Thompson Opeyemi
            <Image src={assets.hand_icon} alt='profile' loading='lazy' className='w-6'/>
        </motion.h3>
        <motion.h1 
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="#contact" 
            className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent'>Contact me <Image src={assets.right_arrow_white} alt='profile' className='w-4'/></motion.a>
            <motion.a
            initial={{y: 30, opacity: 0 }}
            whileInView={{y: 0, opacity: 1}}
